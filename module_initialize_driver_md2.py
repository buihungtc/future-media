        ...
        try:
            ...
            if use_uc:
                try:
                    ...
                    # Dùng profile tách biệt để tránh Chrome đang mở khóa profile chính
                    use_temp = os.getenv("UC_USE_TEMP_PROFILE", "1") == "1"
                    uc_user_dir = path
                    if use_temp:
                        uc_user_dir = tempfile.mkdtemp(prefix="uc_prof_")
